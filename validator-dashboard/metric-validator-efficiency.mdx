...
1. [**Attestations**](./metric-validator-efficiency#attester-efficiency)
2. [**Block proposals**](./metric-validator-efficiency#proposer-efficiency)
3. [**Sync committees**](./metric-validator-efficiency#sync-efficiency)
