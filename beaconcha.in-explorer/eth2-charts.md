...
Displays all the [proposed, missed or oprhaned Blocks](https://kb.beaconcha.in/glossary#block-status) for a specific period of time.

![](https://user-images.githubusercontent.com/26490734/78765940-f3bd3d00-7988-11ea-8734-e6fd35f4e710.gif)
...
![](https://user-images.githubusercontent.com/26490734/78768801-bb1f6280-798c-11ea-91f1-4780830542ee.png)
...
![](https://user-images.githubusercontent.com/26490734/78771349-52d28000-7990-11ea-9ba6-8ba9904e7f4c.png)

### [Validator Balance](https://beaconcha.in/charts/average_balance)

Displays the [current average validator balance](https://kb.beaconcha.in/glossary#current-balance-and-effective-balance) of all validators.

![](https://user-images.githubusercontent.com/26490734/78773270-46035b80-7993-11ea-9ab8-e3c64a63b761.png)

### [Network Liveness](https://beaconcha.in/charts/network_liveness)

Displays how far the last finalized [Epoch](https://kb.beaconcha.in/glossary#epoch) compared to the Head Epoch took place. A minimum of two epochs is caused by how [finalization](https://kb.beaconcha.in/glossary#finalization) works. The network is undergoing finality issues if the network liveness is **more than two** epochs.

![](https://user-images.githubusercontent.com/26490734/78787440-a4880400-79aa-11ea-83c3-d8f57990b964.png)
...
![](https://user-images.githubusercontent.com/26490734/78872647-e4ea8f00-7a49-11ea-9bfa-625fc747e9e6.png)
...
![](https://user-images.githubusercontent.com/26490734/78874403-a3a7ae80-7a4c-11ea-9527-356ce17e81f6.png)
...
![](https://user-images.githubusercontent.com/26490734/78874836-49f3b400-7a4d-11ea-83f3-8254a94a0611.png)
...
![](https://user-images.githubusercontent.com/26490734/78877206-c63bc680-7a50-11ea-901b-ab27a404c581.png)

### [Deposits](https://beaconcha.in/charts/deposits)

Displays the amount of ETH deposited to **ETH1** \(**Success**\), and how many of those transactions failed because of an invalid BLS signature **\(ETH1 failed\)**.  
**ETH2** represents the successful deposits after their waiting time of [~7.5 hours](https://kb.beaconcha.in/ethereum-2.0-and-depositing-process).

![](../.gitbook/assets/firefox_2020-07-11_09-18-33.png)
