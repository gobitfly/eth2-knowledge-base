...
* [Step by Step: How to join the Ethereum 2.0 Testnet](tutorial-eth2-multiclient/README.md)
  * [Prysm client](tutorial-eth2-multiclient/prysm-client/README.md)
    * [Windows](tutorial-eth2-multiclient/prysm-client/windows-prysm/README.md)
      * [Beaconnode & validator with Windows using Prysm.bat](tutorial-eth2-multiclient/prysm-client/windows-prysm/script-beaconnode-and-validator.md)
    ...
    * [macOS](tutorial-eth2-multiclient/prysm-client/macos-prysm/README.md)
      * [Beaconnode & validator with macOS using prysm.sh script](tutorial-eth2-multiclient/prysm-client/macos-prysm/run-with-macos-using-prysm.sh.md)
    ...
    * [Run a Slasher with using prysm.sh \(Windows & macOS \)](tutorial-eth2-multiclient/prysm-client/slasher-windows-macos--prysm.md)
